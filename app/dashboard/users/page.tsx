...
const fetchUsers = async (page: number) => {
  ...
  const res = await fetch(`${BASE_API_URL}/${USERS_URL}?page=${page}`);
...
const UsersPage = () => {
  ...
  const upperBound =
    activePage * DEFAULT_PAGE_LIMIT > count
      ? count
      : activePage * DEFAULT_PAGE_LIMIT;
      ...
      <Card>
        <div className='pb-2 mb-2 border-b-2 flex flex-row justify-between align-center'>
          ...
          <Link
            ...
            className='flex justify-center align-center bg-purple-600 rounded-full px-4 py-1 hover:bg-purple-500 text-white'
          >
